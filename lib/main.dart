...
Error lib/WidgetItems/bottom_sheet_add_task.dart ::: I don't know how to resize the DatePicker's words (too small => big).
...
Error lib/Components/task_item.dart : The attributes in the *task_item*, right or wrong (widget.title/description) ?
